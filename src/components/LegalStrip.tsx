          ...
          <div className="grid grid-cols-1 gap-4">
            <AnimatedItem>
              <div className="flex items-center gap-3 rounded-lg border border-neutral-800 bg-black/50 px-4 py-3 text-white backdrop-blur-sm">
                <BadgeCheck strokeWidth={2} className="h-6 w-6 shrink-0 text-mayans-red" />
            ...
            <AnimatedItem>
              <div className="flex items-start gap-3 rounded-lg border border-neutral-800 bg-black/50 px-4 py-3 text-white backdrop-blur-sm">
                <MapPin strokeWidth={2} className="mt-0.5 h-6 w-6 shrink-0 text-mayans-red" />
